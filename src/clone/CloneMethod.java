...
public class CloneMethod implements Cloneable{//Implement the Cloneable interface
    ...
    public Object clone() {//Override the clone method
        try {//Try to clone the object
            CloneMethod cm = (CloneMethod) super.clone();//Cast the object to the type of the class to make sure is the correct class
            cm.name = name;//Assign the value of the variable to the new object
